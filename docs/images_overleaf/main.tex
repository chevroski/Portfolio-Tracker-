...
\begin{figure}[H!]
    \centering
    \includegraphics[width=0.85\textwidth]{page_principale.png}
...
\begin{figure}[H!]
    \centering
    \includegraphics[width=0.45\textwidth]{ajout_portfolio.png}
    \hfill
    \includegraphics[width=0.45\textwidth]{ajout_asset.png}
    \caption{Formulaires d'ajout : Portfolio (gauche) et Asset (droite)}
\end{figure}
...
\begin{figure}[H!]
    \centering
    \includegraphics[width=0.4\textwidth]{passphrase.png}
